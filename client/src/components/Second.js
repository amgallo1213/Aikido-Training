const SecondKyu = () => {
    return ( 
        <div>
            <h1 style={{ color: '#7f4f24'}}>Second Kyu</h1>
            <div>
                <h3>Student Goals</h3>
                ...
                <p>Take two workshops and clinics or more in present year</p>
                <p>Begin next Gakushu classes (6)</p>
            </div>
            <form>
                <table className="Table">
                    ...
                    <tr>
                        <td>(All direction, elbow lock, cross hand, reverse hand, step-in,</td>
                    </tr>
                    <tr><td>hitting elbow, first control, second control, rotary, step-in)</td></tr>
                    <tr><td></td></tr>
                    ...
                    <tr>(Hand chop block, duck under arm) Breath throw (Both knees down) (A)</tr>
                    <tr><td></td></tr>
                    ...
                    <tr>Second control throw #1</tr>
                    <tr>Third control throw #1</tr>
                    <tr>All direction throw #1</tr>
                    <tr>Step-in throw #1</tr>
                    <tr>Reverse hand throw pin #1</tr>
                </table>
            </form>
        </div>
     );
